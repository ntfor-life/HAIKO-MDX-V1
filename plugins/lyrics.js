...
const text = m.body.slice(prefix.length + cmd.length).trim();
  ...
  if (validCommands.includes(cmd)) {
    ...
    try {
      await m.React('🕘');
      await m.reply('A moment, *𝐇𝐀𝐈𝐊𝐎-𝐌𝐃𝐗-𝐕𝟏🪀* is generating your lyrics request...');
      ...
      if (result && result.lyrics) {
        ...
        let buttons = [{
          ...
          },
          {
            name: "cta_url",
            buttonParamsJson: JSON.stringify({
              display_text: "sʜᴏᴡ 💜 ғᴏʀ HAIKO-MDX-V1",
              url: `https://whatsapp.com/channel/0029Vb9qyTY47XeJ7i0wcQ40`
            })
          },
          {
            name: "quick_reply",
            ...
            message: {
              ...
              interactiveMessage: proto.Message.InteractiveMessage.create({
                ...
                footer: proto.Message.InteractiveMessage.Footer.create({
                  text: "> *© ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴅᴇᴠ ᴘʀᴏғᴇssᴇᴜʀ*"
                }),
